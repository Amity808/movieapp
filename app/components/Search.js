  ...
  return (
    <div className=''>
      <form onSubmit={handleSearch} className='flex items-center border-2 border-solid rounded-sm justify-center max-sm:ml-16 max-sm:w-[250px]'>
        <input type='text' value={search} onChange={(e) => setSearch(e.target.value)} placeholder='What do you want to watch?' className=' text-base font-normal text-white bg-transparent  w-[525px] max-sm:w-[200px] max-md:w-[250px] border-none pl-3 max-sm:pl-0 ' />
      ...
      {toggle && (
        ...
        <div className='relative z-10 bg-white/80 overflow-auto h-[300px]'>      
